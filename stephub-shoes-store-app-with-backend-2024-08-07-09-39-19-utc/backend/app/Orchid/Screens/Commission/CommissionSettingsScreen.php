...
class CommissionSettingsScreen extends Screen
{
    private const SECTIONS = [
        'settings' => [
            ...
            'description' => 'หน้าแก้ค่า commission กลางสำหรับ Stephub BAO ใช้ปรับ direct, unilevel, matrix, reentry, pool, cashback และการแสดงผลเมนูบนแอปจากหน้าเดียว.',
            'accent' => '#4f46e5',
            'cards' => [
                ...
                ['label' => 'Matrix + Reentry', 'value' => 'Live runtime', 'note' => 'แก้ board, threshold, reentry, firm, และ pv ได้จากหน้าจอนี้'],
            ...
            'bullets' => [
                ...
                'ถ้าต้องการดู flow แบบแยกหน้า ยังสามารถเข้า direct, unilevel, matrix, reentry, pool, cashback ได้จากเมนูซ้าย',
            ],
        ],
        'direct' => [
            'title' => 'Direct Bonus',
